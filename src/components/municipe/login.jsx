...
function LoginForm() {
    ...
    const handleSubmit = async () => { 
      //TODO: É necessário configurar essa função corretamente após a construção da autenticação no back
        try {
          const response = await axios.get('https://protoon.azurewebsites.net/municipes');
  ...
  return (
    <div>
      ...
      <div class="container-button">
        ...
        <button type="button"  class="shadow__btn" onClick={handleCadastroClick}>Voltar</button>
      </div>
      </div>
      <footer class="footer">
